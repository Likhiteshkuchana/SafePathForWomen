        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-safepath-purple-dark hover:text-safepath-purple transition-colors">
                <Twitter size={20} />
              </a>
              <a href="#" className="text-safepath-purple-dark hover:text-safepath-purple transition-colors">
                <Facebook size={20} />
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/safe-zones" className="text-gray-600 hover:text-safepath-purple transition-colors">Safe Zones</Link></li>
              <li><Link to="/emergency-services" className="text-gray-600 hover:text-safepath-purple transition-colors">Emergency Services</Link></li>
              <li><Link to="/safety-tips" className="text-gray-600 hover:text-safepath-purple transition-colors">Safety Tips</Link></li>
              <li><Link to="/report" className="text-gray-600 hover:text-safepath-purple transition-colors">Report a Zone</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/cookies" className="text-gray-600 hover:text-safepath-purple transition-colors">Cookie Policy</Link></li>
              <li><Link to="/data" className="text-gray-600 hover:text-safepath-purple transition-colors">Data Protection</Link></li>
            </ul>
          </div>
        </div>
